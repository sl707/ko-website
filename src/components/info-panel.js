...
const infoList = [
  ...
  },
  {
    image: '정기총회.jpeg',
    subtitle: "창립과정",
    text: '  1956. 7. 21. 서울 덕수궁에서 「재경고씨회」를 창립하였고 1957. 5. 12. 서울 장춘단공원에서 제2회 정기총회를 개최하는 등 1971년 서울 덕수궁에서 제13회까지 정기총회를 개최하였다.\n' +
    '  1973. 12. 15. 서울 한국회관(북창동)에서 회명을 고씨중앙종문회로 개칭하는 창립총회를 개최하였고 계속 정기총회를 개최하였으며 2023. 3. 23. 대전 뿌리공원에서 제50회 정기총회를 개최하며 오늘에 이르고 있다.\n' +
    '  초대회장은 고재욱, 제24대 현 회장은 고재갑 박사 이다.',
    order: 2
  },
  {
  ...
  <InfoPanelWrapper>
    ...
    {infoList.map(i => (
      <>
        ...
        <InfoBlock image={i.image} text={i.text} order={i.order} subtitle={i.subtitle ?? ""}/>
      </>
    ))}
  </InfoPanelWrapper>
)
