const unsortedPostList = [
  ...
  },
  {
    ...
    '충남 금산군 고씨문충공파 휘 상령종중(회장 고광찬)은 2023년 11월 18일(토) 11:00 충남 금산군 부리면 창평리 101번지 영모제에서 전국 여러 지역에서 50여명의 종문들이 참석한 가운데 상령종중 시제를 봉행 하였다. \n'+
    '제1부 총회는 고재중 전회장의 개회사 겸 종훈낭독, 고광찬 상령종중회장 인사, 고권기 금산종문회장 인사, 고광우 고문 인사에 이어서 고재중 전 회장이 고재갑 중앙종문회장을 소개하고 계속해서 고재갑 중앙종문회장이 격려사를 하였다. \n' +
